...
export const Hero = () => {
  return (
    <section className="relative overflow-hidden bg-cream pt-20" style={{ backgroundImage: `url(${heroBg})`, backgroundSize: '60%', backgroundPosition: 'center top', backgroundRepeat: 'no-repeat' }}>
