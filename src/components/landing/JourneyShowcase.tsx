                  ...
                  {step.highlights && (
                    <>
                      ...
                      <motion.span
                        ...
                        viewport={{ once: true }}
                        className="absolute -left-48 top-[2%] lg:-right-72 lg:left-auto lg:top-[5%] font-display text-3xl font-extrabold text-coral whitespace-nowrap select-none pointer-events-none"
                      >
                        Age & Energy
                      </motion.span>
                      <motion.span
                        ...
                        className="absolute -right-48 top-[28%] lg:-right-72 lg:top-[30%] font-display text-3xl font-extrabold text-sky whitespace-nowrap select-none pointer-events-none"
                      >
                        Nap Windows
                      </motion.span>
                      <motion.span
                        ...
                        className="absolute -left-48 top-[55%] lg:-right-72 lg:left-auto lg:top-[55%] font-display text-3xl font-extrabold text-sunny whitespace-nowrap select-none pointer-events-none"
                      >
                        Allergies
                      </motion.span>
                      <motion.span
                        ...
                        className="absolute -right-48 top-[78%] lg:-right-72 lg:top-[78%] font-display text-3xl font-extrabold text-mint whitespace-nowrap select-none pointer-events-none"
                      >
                        Interests
                      </motion.span>
                    </>
